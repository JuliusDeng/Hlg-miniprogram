...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([[7],[3,'show']])
Z([3,'position-fixed top-0 left-0 right-0 bottom-0 loading-model data-v-aac2dbcc'])
Z([3,'spinner data-v-aac2dbcc'])
Z([3,'double-bounce1 data-v-aac2dbcc'])
Z([3,'double-bounce2 data-v-aac2dbcc'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'j-center row p-3'])
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'indexnav']])
Z(z[1])
Z([3,'span-4 d-flex flex-column a-center j-center index-nav'])
Z([3,'widthFix'])
Z([[6],[[7],[3,'item']],[3,'src']])
...
Z([[4],[[5],[1,'title']]])
Z([3,'d-flex a-center j-sb px-3'])
Z([3,'title'])
Z([3,'font-lg font-weight'])
Z([3,'font-size:35rpx;'])
Z([a,[[7],[3,'item']]])
...
Z([[7],[3,'cardimg']])
Z(z[0])
Z([3,'scroll-row-item ml-3 mt-1'])
Z([3,'width:280rpx;height:400rpx;'])
Z([3,'rounded-12'])
Z([[6],[[7],[3,'item']],[3,'src']])
...
Z(z[3])
Z([3,'__e'])
Z([3,'swiper-item px-3'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[[5],[1,'event']],[[4],[[5],[1,'$0']]]],[[4],[[5],[[4],[[5],[[4],[[5],[[5],[[5],[1,'swipers']],[1,'']],[[7],[3,'index']]]]]]]]]]]]]]]])
Z([3,'imagea rounded-24 '])
Z([[6],[[7],[3,'item']],[3,'src']])
...
var x=['./common/mixin/loading-plus.wxml','./components/common/divider.wxml','./components/common/loading.wxml','./components/index/index-nav.wxml','./components/index/slidex.wxml','./components/index/swiper-image.wxml','./pages/index/index.wxml'];d_[x[0]]={}
...
var hU=_mz(z,'image',['mode',6,'src',1,'style',2],[],xQ,oP,gg)
_(cT,hU)
var oV=_n('text')
_rz(z,oV,'class',9,xQ,oP,gg)
var cW=_oz(z,10,xQ,oP,gg)
_(oV,cW)
_(cT,oV)
_(oR,cT)
return oR
...
var o6=_mz(z,'slidex',['bind:__l',4,'vueId',1,'vueSlots',2],[],b3,e2,gg)
var f7=_mz(z,'card',['bind:__l',7,'vueId',1,'vueSlots',2],[],b3,e2,gg)
var c8=_mz(z,'view',['class',10,'slot',1],[],b3,e2,gg)
var h9=_mz(z,'text',['class',12,'style',1],[],b3,e2,gg)
var o0=_oz(z,14,b3,e2,gg)
_(h9,o0)
_(c8,h9)
var cAB=_n('view')
_rz(z,cAB,'class',15,b3,e2,gg)
var oBB=_oz(z,16,b3,e2,gg)
_(cAB,oBB)
var lCB=_n('text')
_rz(z,lCB,'class',17,b3,e2,gg)
_(cAB,lCB)
_(c8,cAB)
_(f7,c8)
_(o6,f7)
var aDB=_mz(z,'scroll-view',['scrollX',-1,'class',18],[],b3,e2,gg)
var tEB=_v()
_(aDB,tEB)
var eFB=function(oHB,bGB,xIB,gg){
var fKB=_mz(z,'view',['class',23,'style',1],[],oHB,bGB,gg)
var cLB=_mz(z,'image',['class',25,'src',1],[],oHB,bGB,gg)
_(fKB,cLB)
_(xIB,fKB)
return xIB
}
tEB.wxXCkey=2
_2z(z,21,eFB,b3,e2,gg,tEB,'item','index','index')
_(o6,aDB)
_(o4,o6)
return o4
}
...
var z=gz$gwx_6()
var oNB=_n('view')
var cOB=_mz(z,'swiper',['autoplay',-1,'circular',-1,'duration',0,'indicatorDots',1,'interval',1],[],e,s,gg)
var oPB=_v()
_(cOB,oPB)
var lQB=function(tSB,aRB,eTB,gg){
var oVB=_n('swiper-item')
var xWB=_mz(z,'view',['bindtap',7,'class',1,'data-event-opts',2],[],tSB,aRB,gg)
var oXB=_mz(z,'image',['lazyLoad',-1,'class',10,'src',1],[],tSB,aRB,gg)
_(xWB,oXB)
_(oVB,xWB)
_(eTB,oVB)
return eTB
...
oPB.wxXCkey=2
_2z(z,5,lQB,e,s,gg,oPB,'item','index','index')
_(oNB,cOB)
_(r,oNB)
return r
}
...
var o2B=_mz(z,'input',['class',2,'style',1,'type',2,'value',3],[],e,s,gg)
_(h1B,o2B)
_(cZB,h1B)
var c3B=_mz(z,'swiper-image',['bind:__l',6,'swipers',1,'vueId',2],[],e,s,gg)
_(cZB,c3B)
var o4B=_mz(z,'index-nav',['bind:__l',9,'indexnav',1,'vueId',2],[],e,s,gg)
_(cZB,o4B)
var l5B=_mz(z,'divider',['bind:__l',12,'vueId',1],[],e,s,gg)
_(cZB,l5B)
var a6B=_mz(z,'slidex',['bind:__l',14,'cardimg',1,'cardtitle',2,'vueId',3],[],e,s,gg)
_(cZB,a6B)
_(r,cZB)
return r
}
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:5050:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:5050:1)",{path:"./app.wxss"});    
...
__wxAppCode__['components/common/loading.wxss']=setCssToHead([".",[1],"loading-model.",[1],"data-v-aac2dbcc{ background: rgba(255, 255, 255, 0.6); z-index: 1000; }\n.",[1],"spinner.",[1],"data-v-aac2dbcc { width: 60px; height: 60px; position: relative; margin: ",[0,300]," auto; z-index: 1000; }\n.",[1],"double-bounce1.",[1],"data-v-aac2dbcc, .",[1],"double-bounce2.",[1],"data-v-aac2dbcc { width: 100%; height: 100%; border-radius: 50%; background-color: #FD6801; opacity: 0.6; position: absolute; top: 0; left: 0; -webkit-animation: bounce-data-v-aac2dbcc 2.0s infinite ease-in-out; animation: bounce-data-v-aac2dbcc 2.0s infinite ease-in-out; z-index: 1000; }\n.",[1],"double-bounce2.",[1],"data-v-aac2dbcc { -webkit-animation-delay: -1.0s; animation-delay: -1.0s; }\n@-webkit-keyframes bounce-data-v-aac2dbcc { 0%, 100% { -webkit-transform: scale(0.0); transform: scale(0.0); }\n50% { -webkit-transform: scale(1.0); transform: scale(1.0); }\n}@keyframes bounce-data-v-aac2dbcc { 0%, 100% { -webkit-transform: scale(0.0); transform: scale(0.0); }\n50% { -webkit-transform: scale(1.0); transform: scale(1.0); }\n}",],undefined,{path:"./components/common/loading.wxss"});    
...
__wxAppCode__['components/index/slidex.wxss']=undefined;    
__wxAppCode__['components/index/slidex.wxml']=$gwx('./components/index/slidex.wxml');

__wxAppCode__['components/index/swiper-image.wxss']=setCssToHead([".",[1],"imagea{ height: ",[0,300],"; width: 100%; }\n",],undefined,{path:"./components/index/swiper-image.wxss"});    
